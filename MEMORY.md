...
- **Project Rebranding:** All instances of 'borg', 'nexus', 'hypervisor', 'aios', 'metamcp', 'claude-mem', 'prism', 'hypercode', and 'TormentNexus' (case-insensitive) must be renamed to 'TormentNexus'.
