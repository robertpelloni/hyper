...
TormentNexus is a high-performance terminal and autonomous agent harness built with Go and Electron. It aims to integrate features from top-tier AI-powered terminals into a unified, extensible platform.
...
- Robust terminal performance (xterm.js + Go PTY).
- Rich UI feedback for agentic actions.
